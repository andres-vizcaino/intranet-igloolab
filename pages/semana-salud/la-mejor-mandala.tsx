import CreateMandalaModal from 'components/CreateContent'
...
const LaMejorMandala: NextApplicationPage = () => {
  ...
  const [haveMandalaPublish, setHaveMandalaPublish] = useState<
    boolean | undefined
  >(false)
  ...
  return (
    <div className="text-center mt-5">
      <h1 className="text-2xl font-bold md:text-4xl">
        Mandalas <span className="text-red-500">igloolab</span> - Semana de la
        salud
      </h1>
          ...
          >
            ...
            <div className="flex gap-1 justify-center items-baseline">
              ...
              {session?.user.id === mandala.owner.id && (
                <button onClick={() => deletemandalaselect(mandala.id)}>
                  ❌
                </button>
              )}
            </div>
